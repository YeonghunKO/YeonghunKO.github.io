...
```href="apple-icon-57x57.png">``` 코드에서 ```href=``` 뒤에 <code>{{site.baseurl}}/assets/logo.ico/</code> 를 추가하자.  
<code>href="{{site.baseurl}}/assets/logo.ico/apple-icon-57x57.png"></code> 이렇게 말이다.  
