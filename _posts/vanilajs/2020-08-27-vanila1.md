---
title:  "<1> 바닐라 JS 로 구글 크롬앱 만들기(기초 다지기. html , css 뼈대 만들고 자바스크립트 기본 문법1)"
excerpt: "크롬앱"
...
<html> 
   <head>
       <title>무모</title>
       <link rel="stylesheet"
       href = "index.css" /> <!--index.css 파일안에 css언어로 디자인을 집약할 생각-->
   </head>
   <body> 
       <h1 id = "title" >This will work. so Don't worry</h1>
       <script src="index.js"></script> <!--자바스트립트 코드는 index.js 파일에 모아놀 생각-->
   </body>
</html>
```
